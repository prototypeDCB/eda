...
/** Clase MonticuloBinarioR0: representa un Heap con Raiz en 0.
 * 
...
public class MonticuloBinarioR0<E extends Comparable<E>> 
    ...
    public void insertar(E e) {
        ...
        int  posActual = talla++; // REMEMBER: Last element is at position talla - 1
    ...
    public E eliminarMin() {
        ...
        elArray[0] = elArray[--talla]; // REMEMBER: Last element is at position talla - 1
        hundir(0);
        return elMinimo;
    }
    ...
    protected void hundir(int pos) {
        ...
        // REMEMBER: Last element is at position talla - 1 (look at hijo < talla)
        while (hijo < talla && !esHeap) {
            // REMEMBER: Last element is at position talla - 1
            if (hijo != talla - 1
